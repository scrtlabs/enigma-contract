...
library PrincipalImplV2 {
    ...
    public
    {
        ...
        require(_blockNumber - WorkersImplV2.getFirstBlockNumberImpl(state, _blockNumber) >= state.epochSize,
    ...
    returns (address[] memory, uint[] memory)
    {
        ...
        for (uint i = 0; i < maxLength; i++) {
            ...
            EnigmaCommon.WorkerLog memory workerLog = WorkersImplV2.getLatestWorkerLogImpl(worker, _blockNumber);
