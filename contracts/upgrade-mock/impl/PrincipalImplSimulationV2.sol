...
import { WorkersImplSimulationV2 } from "./WorkersImplSimulationV2.sol";
 ...
 */
library PrincipalImplSimulationV2 {
    ...
    public
    {
        ...
        require(_blockNumber - WorkersImplSimulationV2.getFirstBlockNumberImpl(state, _blockNumber) >= state.epochSize,
    ...
    returns (address[] memory, uint[] memory)
    {
        ...
        for (uint i = 0; i < maxLength; i++) {
            ...
            EnigmaCommon.WorkerLog memory workerLog = WorkersImplSimulationV2.getLatestWorkerLogImpl(worker, _blockNumber);
