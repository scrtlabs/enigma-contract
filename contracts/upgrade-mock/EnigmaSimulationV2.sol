...
import { WorkersImplSimulationV2 } from "./impl/WorkersImplSimulationV2.sol";
import { PrincipalImplSimulationV2 } from "./impl/PrincipalImplSimulationV2.sol";
import { TaskImplSimulationV2 } from "./impl/TaskImplSimulationV2.sol";
...
contract EnigmaSimulationV2 is EnigmaStorage, EnigmaEvents, Getters, Ownable {
    ...
    */
    ...
    {
        WorkersImplSimulationV2.registerImpl(state, _stakingAddress, _signer, _report, _signature, _upgradeTransferSig);
    }
    ...
    */
    ...
    {
        WorkersImplSimulationV2.depositImpl(state, _custodian, _amount);
    }
    ...
    */
    ...
    isUpdatedEnigmaContract
    {
        TaskImplSimulationV2.createTaskRecordImpl(state, _inputsHash, _gasLimit, _gasPx, _firstBlockNumber);
    }
    ...
    */
    ...
    taskWaiting(_taskId)
    {
        TaskImplSimulationV2.returnFeesForTaskImpl(state, _taskId);
    }
    ...
    */
    ...
    {
        return PrincipalImplSimulationV2.getActiveWorkersImpl(state, _blockNumber);
    }
    ...
    */
    ...
    view
    returns (uint) {
        return WorkersImplSimulationV2.getFirstBlockNumberImpl(state, _blockNumber);
    }
    ...
    */
    ...
    returns (uint, uint, address[] memory, uint[] memory) {
        return WorkersImplSimulationV2.getWorkerParamsImpl(state, _blockNumber);
    }
    ...
    */
    ...
    {
        return WorkersImplSimulationV2.getWorkerGroupImpl(state, _blockNumber, _scAddr);
    }
    ...
    */
    ...
    returns (uint)
    {
        return WorkersImplSimulationV2.verifyReportImpl(_data, _signature);
    }
    ...
    */
    ...
    {
        WorkersImplSimulationV2.setOperatingAddressImpl(state, _operatingAddress);
    }
}
