...
contract EnigmaSimulation is EnigmaStorage, EnigmaEvents, Getters, Ownable {
    ...
    */
    ...
    {
        TaskImplSimulation.commitReceiptImpl(state, _sig, _gasUsed, _optionalEthereumContractAddress,
    ...
    */
    ...
    {
        WorkersImplSimulation.setOperatingAddressImpl(state, _operatingAddress);
    }
}
